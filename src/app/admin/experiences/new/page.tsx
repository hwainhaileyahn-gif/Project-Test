...
import { createExperience } from '@/app/actions/resume'
    ...
    <div className="min-h-screen bg-neutral-50 px-6 py-12">
      <div className="max-w-2xl mx-auto">
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-bold text-neutral-900">경력 추가</h1>
          <p className="text-sm text-neutral-500 mt-1">새 경력 사항을 입력하세요</p>
        </div>
